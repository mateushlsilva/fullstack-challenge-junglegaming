...
import { TaskUpdateTemplate } from '@/templates';
...
export default function TaskUpdatePage({ id }: TaskUpdatePageProps) {
    ...
    return (
        <TaskUpdateTemplate className="min-h-screen flex items-center justify-center p-4">
            <div className="flex items-center justify-center w-full">

                <Card className="w-full max-w-[700px] bg-[#1A1A1A] p-6 sm:p-6 rounded-lg shadow-lg shadow-[#0A0A0A]">
                    <CardHeader>
